...
from .api import health_routes, ner_routes, translator_routes, summarizer_routes, classifier_route, whisper_routes, audio_routes, call_session_routes, qa_route, processing_mode_routes, notification_routes, agent_feedback_routes, attention_fusion_routes
...
app.include_router(attention_fusion_routes.router)
...
async def root():
    ...
    return {
        ...
        "endpoints": {
            ...
            "fusion_analyze": "/fusion/analyze",
            "fusion_ner": "/fusion/ner",
            "fusion_classify": "/fusion/classify",
            "fusion_qa": "/fusion/qa",
            "fusion_info": "/fusion/info",
