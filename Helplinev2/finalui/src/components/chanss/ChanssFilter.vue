  ...
  >
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="flex flex-col">
        ...
        <input type="number" v-model="filters.durationMin" placeholder="Min" min="0"
          class="rounded px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 placeholder-gray-500 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 placeholder-gray-400 focus:ring-amber-600'" />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input type="number" v-model="filters.durationMax" placeholder="Max" min="0"
          class="rounded px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 placeholder-gray-500 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 placeholder-gray-400 focus:ring-amber-600'" />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input type="number" v-model="filters.occupancyMin" placeholder="0-100" min="0" max="100"
          class="rounded px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 placeholder-gray-500 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 placeholder-gray-400 focus:ring-amber-600'" />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input type="number" v-model="filters.occupancyMax" placeholder="0-100" min="0" max="100"
          class="rounded px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 placeholder-gray-500 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 placeholder-gray-400 focus:ring-amber-600'" />
      </div>
...
function applyFilters() {
  ...
  if (filters.durationMin || filters.durationMax) {
    ...
    const max = filters.durationMax || '999999'
    params.duration = `${min};${max}`
  }

  if (filters.occupancyMin || filters.occupancyMax) {
    const min = filters.occupancyMin || '0'
    const max = filters.occupancyMax || '100'
    params.occupancy_rate = `${min};${max}`
  }
...
function resetFilters() {
  ...
  filters.durationMin = ''
  filters.durationMax = ''
  filters.occupancyMin = ''
  filters.occupancyMax = ''
